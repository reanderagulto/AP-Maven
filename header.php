...
<body <?php body_class(); ?>>
	...
	<header class="header">
		<div class="desktop-menu">			
			<div class="site-header-logo">
				<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('AP Maven Logo') ) : ?>
				<?php endif ?>
			</div>
    ...
    ?>
		<!-- ip banner goes here -->
		<div class="ip-banner">
			<?php if ( ! is_home() && !is_page_template( 'template-homepage.php' ) &&  is_active_sidebar('aios-inner-pages-banner')) {
				dynamic_sidebar('aios-inner-pages-banner');
			}
			?>
		</div>	
